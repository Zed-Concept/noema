#!/usr/bin/env bash
#
# Runner for the REVIEW-023 findings 1+2 probe (Unit E fix cycle 2 re-run,
# CTRL-006). Inherited from ../006b-session-durability-fix1/review023-probe.sh
# unchanged except for this directory's paths: it copies THIS directory's
# re-based review023-probe.tsx (the fake models the directory listing the
# REVIEW-024 finding-1 consult corroborates absence with; schedules and the
# pinned trees are unchanged — see that file's header).
#
