...
# finding 5, committed as an instrument; carried into 006d unchanged apart
# from this directory's paths (ruling 28: cycle 3 changes no behaviour —
# the 006d capture narrows PROSE only and must still fail closed under a
# refusing git).
#
...
VERDICT_FAIL=0
{
  ...
  echo "# refusal; this transcript is the committed proof the 006d producer"
  echo "# does not."
  echo
