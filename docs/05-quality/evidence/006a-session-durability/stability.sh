#!/usr/bin/env bash
#
# Byte-stability gate for 006a — session durability (Unit E, CTRL-006).
#
...
#
# finding3-probe.txt is also not compared here: finding3-probe.sh produces it
# from jest runs in disposable worktrees, and jest failure output orders some
# lines by timing. Its verdict block and the runner's exit status are its
# contract, stated in the README rather than gated here.
#
